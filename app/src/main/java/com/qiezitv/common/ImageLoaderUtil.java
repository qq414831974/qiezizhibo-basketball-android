...
public final class ImageLoaderUtil {
    ...
    public static void init() {
        sOptions = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.ic_football) //设置图片在下载期间显示的图片
                .showImageForEmptyUri(R.drawable.ic_football)//设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.drawable.ic_football)  //设置图片加载/解码过程中错误时候显示的图片
